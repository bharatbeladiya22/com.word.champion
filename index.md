...
When you view ads in Lydia Games properties(e.g. in our games)

3.2 To enable us to show in-game ads, we may send your advertising ID and IP address to advertisers (or ad networks) to enable them to find appropriate ads to serve to you in our Games and on third-party properties. You can control and limit our use of your advertising ID in your device settings. Lydia Games does not control which specific ads are shown in our games (this is controlled by ad networks), but we do prohibit certain types of ads.
...
(d) Other brands buy ad placements via an ad network or ad exchange to advertise their products in Lydia Games. The ad network or ad exchange acts as intermediary between the other game companies and Lydia Games. In order for an ad network to charge the company purchasing the ad, clicks from the ad and potential installs of other developers’ apps are tracked. Views, clicks and installs from ads are measured using the Advertising ID.
...
When you view Lydia Games' ads on third-party services

3.4 Lydia Games also advertises its games on other apps by asking ad networks to place ads for audiences that will be interested in them (determined using Advertising IDs).
...
(b) Inform players that have not played for a while about new content in the Game. Lydia Games gives a list of these users in the form of Advertising IDs to an ad network. The ad network then shows these users ads about the new content.

(c) Not display ads for a game a player is already playing. Lydia Games may send a list of active players in the form of Advertising IDs to an ad network. The ad network then excludes these players from seeing the ad.

(d) Market games to a group of potential players. Lydia Games provides Facebook a list of Advertising IDs to match them with similar type of Facebook users to whom Lydia Games could then market its games. Lydia Games does not have information on how Facebook identifies or creates profiles of similar type of users.
...
6. WHO DOES LYDIA GAMES SHARE MY PERSONAL INFORMATION WITH?
...
7. HOW DOES LYDIA GAMES KEEP MY PERSONAL INFORMATION SECURE?
...
Data controller: Lydia Games LLC Ankara, Turkey. Email: lydiagamestudios@gmail.com.
