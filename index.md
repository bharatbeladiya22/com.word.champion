...
We are Insight App Studio, maker of Word Champion. For details about how to contact us, see the "How To Contact Us" section below.
...
1. WHAT PERSONAL INFORMATION DOES Insight App Studio COLLECT?
...
When you view ads in Insight App Studio properties(e.g. in our games)

3.2 To enable us to show in-game ads, we may send your advertising ID and IP address to advertisers (or ad networks) to enable them to find appropriate ads to serve to you in our Games and on third-party properties. You can control and limit our use of your advertising ID in your device settings. Insight App Studio does not control which specific ads are shown in our games (this is controlled by ad networks), but we do prohibit certain types of ads.
...
(d) Other brands buy ad placements via an ad network or ad exchange to advertise their products in Insight App Studio. The ad network or ad exchange acts as intermediary between the other game companies and Insight App Studio. In order for an ad network to charge the company purchasing the ad, clicks from the ad and potential installs of other developers’ apps are tracked. Views, clicks and installs from ads are measured using the Advertising ID.
...
When you view Insight App Studio' ads on third-party services

3.4 Insight App Studio also advertises its games on other apps by asking ad networks to place ads for audiences that will be interested in them (determined using Advertising IDs).
...
(b) Inform players that have not played for a while about new content in the Game. Insight App Studio gives a list of these users in the form of Advertising IDs to an ad network. The ad network then shows these users ads about the new content.

(c) Not display ads for a game a player is already playing. Insight App Studio may send a list of active players in the form of Advertising IDs to an ad network. The ad network then excludes these players from seeing the ad.

(d) Market games to a group of potential players. Insight App Studio provides Facebook a list of Advertising IDs to match them with similar type of Facebook users to whom Insight App Studio could then market its games. Insight App Studio does not have information on how Facebook identifies or creates profiles of similar type of users.
...
6. WHO DOES Insight App Studio SHARE MY PERSONAL INFORMATION WITH?
...
7. HOW DOES Insight App Studio KEEP MY PERSONAL INFORMATION SECURE?
...
Data controller: Insight App Studio ,India. Email: insightappstudio@gmail.com.
